...
class UsersController extends ControllerBase
{
    ...
    public function editAction($id)
    {
        ...
        if (!$this->request->isPost()) {
            ...
            $this->tag->setDefault("display_name", $user->display_name);
            $this->tag->setDefault("status", $user->status);
            $this->tag->setDefault("registered", $user->registered);
    ...
    public function createAction()
    {
        ...
        $user->registered = $this->request->getPost("registered");
        $user->updated = $this->request->getPost("updated");
