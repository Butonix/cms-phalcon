 ...
 */ -->
    <head>
		...
		<meta content="" name="CMS Project of B Team - ISC" />
		<meta content="" name="B Team - ISC" />
		<!-- end: META -->
		<!-- start: MAIN CSS -->
		...
		<!--[if lt IE 9]>
		<script src="assets/plugins/html5shiv/dist/html5shiv.min.js"></script>
		<![endif]-->
    ...
    <body>
		...
		<script src="assets/plugins/excanvas/excanvas.min.js"></script>
		<script src="assets/plugins/html5shiv/dist/html5shiv.min.js"></script>
		<script type="text/javascript" src="assets/plugins/jQuery-lib/1.11.3/jquery-1.11.3.min.js"></script>
		<![endif]-->
		<!--[if gte IE 9]><!-->
		<script src="assets/plugins/jQuery-lib/2.1.4/jquery-2.1.4.min.js"></script>
		<!--<![endif]-->
		<script src="assets/plugins/bootstrap/js/bootstrap.min.js"></script>
		<script src="assets/plugins/jquery.transit/jquery.transit.js"></script>
		<script src="assets/plugins/hover-dropdown/bootstrap-hover-dropdown.min.js"></script>
		<script src="assets/plugins/jquery.appear/jquery.appear.js"></script>
		<script src="assets/plugins/blockUI/jquery.blockUI.js"></script>
		<script src="assets/plugins/jquery-cookie/src/jquery.cookie.js"></script>
