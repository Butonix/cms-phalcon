...
<html lang="en" class="no-js">
	...
	<head>
		...
		<link rel="stylesheet" href="assets/css/back-end/main.css">
		<link rel="stylesheet" href="assets/css/back-end/main-responsive.css">
		<link rel="stylesheet" href="assets/plugins/iCheck/skins/all.css">
		<link rel="stylesheet" href="assets/plugins/bootstrap-colorpalette/css/bootstrap-colorpalette.css">
		<link rel="stylesheet" href="assets/plugins/perfect-scrollbar/src/perfect-scrollbar.css">
		<link rel="stylesheet" href="assets/css/back-end/theme_light.css" type="text/css" id="skin_color">
		<link rel="stylesheet" href="assets/css/back-end/print.css" type="text/css" media="print"/>
		<!--[if IE 7]>
		<link rel="stylesheet" href="assets/plugins/font-awesome/css/font-awesome-ie7.min.css">
		<![endif]-->
		<!-- end: MAIN CSS -->
		<!-- start: CSS REQUIRED FOR THIS PAGE ONLY -->
		<link rel="stylesheet" href="assets/plugins/fullcalendar/dist/fullcalendar.css">
	...
	<body class="navigation-small">
					...
					<ul class="main-navigation-menu">
						...
						<li>
							<a href="javascript:void(0)"><i class="clip-screen"></i>
								<span class="title"> Menu 1 </span><i class="icon-arrow"></i>
							...
							<ul class="sub-menu">
								...
								<li>
									<a href="#">
										<span class="title">  Sub Menu 3 </span>
									</a>
								</li>
								<li>
									<a href="#">
										<span class="title">  Sub Menu 4 </span>
									</a>
								</li>
								<li>
									<a href="#">
										<span class="title">  Sub Menu 5 </span>
									</a>
								</li>
							</ul>
						</li>
						<li>
							<a href="#" target="_blank"><i class="clip-cursor"></i>
								<span class="title"> Menu 12 </span><span class="selected"></span>
							</a>
						</li>
						<li>
							<a href="javascript:void(0)"><i class="clip-cog-2"></i>
								<span class="title"> Menu 3 </span><i class="icon-arrow"></i>
								<span class="selected"></span>
							</a>
							<ul class="sub-menu">
								<li>
						...
						<li>
							<a href="javascript:void(0)"><i class="clip-grid-6"></i>
								<span class="title"> Menu 4 </span><i class="icon-arrow"></i>
								<span class="selected"></span>
							</a>
							<ul class="sub-menu">
								<li>
						...
						<li>
							<a href="javascript:void(0)"><i class="clip-user-2"></i>
								<span class="title">Menu 6</span><i class="icon-arrow"></i>
								<span class="selected"></span>
							</a>
							<ul class="sub-menu">
								<li>
						...
						<li>
							<a href="javascript:void(0)"><i class="clip-file"></i>
								<span class="title">Menu 7</span><i class="icon-arrow"></i>
								<span class="selected"></span>
							</a>
							<ul class="sub-menu">
								<li>
						...
						<li>
							<a href="javascript:void(0)"><i class="clip-attachment-2"></i>
								<span class="title">Menu 8</span><i class="icon-arrow"></i>
								<span class="selected"></span>
							</a>
							<ul class="sub-menu">
								<li>
						...
						<li>
							<a href="javascript:;">
								...
								<span class="title"> Menu 10 </span><i class="icon-arrow"></i>
						...
						<li>
							<a href="#"><i class="clip-location"></i>
								<span class="title">Menu 11</span>
								<span class="selected"></span>
							</a>
						</li>
						<li>
		...
		<script src="assets/plugins/less/dist/less.min.js"></script>
		<script src="assets/plugins/jquery-cookie/src/jquery.cookie.js"></script>
		<script src="assets/plugins/bootstrap-colorpalette/js/bootstrap-colorpalette.js"></script>
		<script src="assets/js/back-end/main.js"></script>
		...
		<script src="assets/js/back-end/index.js"></script>
